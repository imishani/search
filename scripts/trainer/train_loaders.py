...
from scripts import models, losses, datasets, summaries
from scripts.utils import model_loader, pretrain_helper
from scripts.utils_torch import freeze_torch_model
...
def get_dataset(dataset_class=None,
    ...
    print('\n---------------Loading data')
    full_dataset = DatasetClass(data_directory=dataset_path, **kwargs)
    print(full_dataset)
